...
public class task3Extended {
        ...
        public static void main(String[] args) throws IOException {
            ...
            LinkedList<patient> waitingList1 = new LinkedList<>();
            LinkedList<patient> waitingList2= new LinkedList<>();
            LinkedList<patient> waitingList3 = new LinkedList<>();
            String firstName;
            String lastName;
            String age;
            String city;
                ...
                if (menuInput.equals("100") || menuInput.equalsIgnoreCase("VVB")) { //View all Vaccination Booths
                    ...
                    if (vaccineSelect == 1) {
                        ...
                        if (patients[0].getFirstName().equalsIgnoreCase("Empty")) {
                            ...
                            System.out.println();
                            waitingList1.add(new patient(firstName,lastName,age,city,idNum));
                            System.out.println("BOOTH NUMBER 00 AND 01 IS NOT AVAILABLE AT THE MOMENT, YOU'LL BE ADD TO WAITING LIST ");
                            System.out.println();
                        }
                        ...
                        if (patients[2].getFirstName().equalsIgnoreCase("Empty")) {
                            ...
                            System.out.println();
                            waitingList2.add(new patient(firstName,lastName,age,city,idNum));
                            System.out.println("BOOTH NUMBER 02 AND 03 IS NOT AVAILABLE AT THE MOMENT, YOU'LL BE ADD TO WAITING LIST ");
                            System.out.println();
                        }
                        ...
                        if (patients[4].getFirstName().equalsIgnoreCase("Empty")) {
                            ...
                            System.out.println();
                            waitingList3.add(new patient(firstName,lastName,age,city,idNum));
                            System.out.println("BOOTH NUMBER 00 AND 01 IS NOT AVAILABLE AT THE MOMENT, YOU'LL BE ADD TO WAITING LIST ");
                            System.out.println();
                        }
                    ...
                    //Adding patients from waiting list to patient list
                    if(removePatient==0 || removePatient==1){
                        patients[removePatient]=waitingList1.getFirst();
                        waitingList1.removeFirst();
                        vaccineStock=vaccineStock-1;
                    }
                    if(removePatient==2 || removePatient==3){
                        patients[removePatient]=waitingList2.getFirst();
                        waitingList2.removeFirst();
                        vaccineStock=vaccineStock-1;
                    }
                    if(removePatient==4 || removePatient==5){
                        patients[removePatient]=waitingList3.getFirst();
